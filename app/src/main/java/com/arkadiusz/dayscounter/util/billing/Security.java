...
import static com.arkadiusz.dayscounter.util.PurchasesUtils.base64EncodedPublicKey;
...
class Security {
    ...
    final private static String BASE_64_ENCODED_PUBLIC_KEY = base64EncodedPublicKey;
